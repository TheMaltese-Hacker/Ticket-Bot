module.exports = {
	...
	err_colour: 'RED',
	cooldown: 3,
	guild: '817842214201196595', // ID of your guild (REQUIRED)
	staff_role: '820968363240063036', // ID of your Support Team role (REQUIRED)

	tickets: {
		category: '819890475133566986', // ID of your tickets category (REQUIRED)
		send_img: true,
		ping: 'here',
